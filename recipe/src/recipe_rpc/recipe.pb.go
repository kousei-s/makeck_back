...
type Material struct {
	...
	Count         float32                `protobuf:"fixed32,3,opt,name=count,proto3" json:"count,omitempty"` // 個数
...
func (x *Material) GetCount() float32 {
	if x != nil {
		return x.Count
	}
	return 0
...
var file_recipe_proto_rawDesc = string([]byte{
	...
	0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x02, 0x52, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x12,
